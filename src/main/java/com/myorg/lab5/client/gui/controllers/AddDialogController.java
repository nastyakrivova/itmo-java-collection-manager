...
public class AddDialogController {
    ...
    private MusicBand resultBand;
    private boolean confirmed = false;
    
    @FXML
    private void initialize() {
        genreCombo.getItems().setAll(MusicGenre.values());
        genreCombo.setValue(MusicGenre.POP);
        
        addBtn.setOnAction(e -> addBand());
    ...
    private void addBand() {
        try {
            ...
            resultBand = new MusicBand(name, coordinates, participants, albums, genre, studio, singles);
            confirmed = true;
            dialogStage.close();
    ...
    public MusicBand getResultBand() {
        return resultBand;
    }
}